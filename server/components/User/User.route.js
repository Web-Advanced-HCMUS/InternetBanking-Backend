...
router
  .route("/logout")
  .get(authorized(), UserInfoController.userLogoutController);

router
  .route("/get-user-info-by-token")
  .get(authorized(), UserInfoController.getUserInfoController);
...
router
  .route("/change-pass")
  .put(authorized(), UserInfoController.changePasswordController);

router
  .route("/get-user-by-account-number/:accountNumber")
  .get(authorized(), UserInfoController.getUserByAccountNumberController);
